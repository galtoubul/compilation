...
//        throw new UnsupportedOperationException();
    ...
    public static void allocateSpaceForResult(int tempStr1, int tempStr2) {
...
//        throw new UnsupportedOperationException();
    ...
    public void MIPSme(Map<TEMP, Integer> tempMap) {
        ...
        MIPSGenerator.getInstance().concatStrings(tempMap.get(this.t1), tempMap.get(this.t2), tempMap.get(this.dst));
        System.out.println("------------allocateSpaceForConcatStringResult"+tempMap.get(this.t2)+" "+tempMap.get(this.dst));
        // allocate labels
...
//        String labelAfterCopySecondString = Labels.getAvialableLabel("after_copy_second_string");
        ...
        //MIPSGenerator.getInstance().copyString(tempMap.get(this.dst));
    }
}
